...
<head>
  ...
  <title>Admin / Profil - ParkByPhone</title>
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <div class="social-links mt-2">
				...
				<a href="#" class="browser-chrome"> <i class="bi bi-browser-chrome"></i></a>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Bienvenue</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  <h5 class="card-title">Qui Nous Sommes?</h5>
                  <p class="small fst-italic">Chez ParkByPhone
                  <h5 class="card-title">Profil Details</h5>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Nom Complet</div>
                    <div class="col-lg-9 col-md-8">ParkByPhone</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Tunis</div>
                  </div>
...
Lac 0 , Tunis</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">216 52636363 <br> 216 98596320
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">contact@parkbyphone.com</div>
                  </div>
